    ...
    return (
        <>
           ...
           <div className='w-full h-[60vh] flex items-center justify-center border-t shadow-lg border-t-slate-400 my-[8vh] px-8 relative'>
                ...
                <div className='absolute top-1/2 right-12 transform -translate-y-1/  max-w-[40vw] bg-opacity-50 p-6 '>
                       <div className='text-3xl text-[#14489D] font-bold mb-4 flex flex-wrap items-center'>
                            <span>Paga fácil y seguro </span>
                    ...
                    <ul className='list-disc text-[#484848] list-inside mb-4'>
                        ...
                        <p className='text-[#14479D] font-semibold'>
                            Tu pago se acredita al instante para procesar 
                        </p>
                        <span  className='text-[#14479D] font-semibold'>tu pedido sin demoras.</span>
                </div>
                <Footer/>
                </div>
